...
void djui_panel_romhack_camera_create(struct DjuiBase* caller) {
    ...
    struct DjuiBase* body = djui_three_panel_get_body(panel);
    {
        ...
        djui_checkbox_create(body, DLANG(CAMERA, INVERT_X), &configRomhackCameraInvertX, djui_panel_romhack_camera_value_changed);
...
void djui_panel_camera_create(struct DjuiBase* caller) {
    ...
    struct DjuiBase* body = djui_three_panel_get_body(panel);
    {
        ...
        djui_checkbox_create(body, DLANG(CAMERA, INVERT_X), &configFreeCameraInvertX, djui_panel_free_camera_value_changed);
        djui_checkbox_create(body, DLANG(CAMERA, INVERT_Y), &configFreeCameraInvertY, djui_panel_free_camera_value_changed);
